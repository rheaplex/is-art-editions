...
const TOKENS = [
  [
    ...
    "IsArtToken",
    "is-art-token.html",
    `ipfs://${IMAGES_DIR_HASH}/image/is.png`
  ],
  [
    ...
    `ipfs://${IMAGES_DIR_HASH}/block-height/$ID.png`
  ],
  [
    ...
    `ipfs://${IMAGES_DIR_HASH}/because/$ID.png`
  ],
  [
    "Is Art (Token, Burn)",
  ...
  [
    ...
    `ipfs://${IMAGES_DIR_HASH}/composition/$ID.png`
  ],
  [
    ...
    `ipfs://${IMAGES_DIR_HASH}/democratic-palette/$ID.png`
  ],
  [
    ...
    `ipfs://${IMAGES_DIR_HASH}/image/democratic.png`
  ],
  [
  ...
  [
    ...
    `ipfs://${IMAGES_DIR_HASH}/is-x/$ID.png`
  ],
  [
  ...
  [
    ...
    `ipfs://${IMAGES_DIR_HASH}/nominational/$ID.png`
  ],
  [
  ...
  [
    ...
    `ipfs://${IMAGES_DIR_HASH}/secret/$ID.png`
  ],
  [
    ...
    `ipfs://${IMAGES_DIR_HASH}/image/metadata-is.png`
  ],
  [
    "Is Art (This)",
    ...
    `ipfs://${IMAGES_DIR_HASH}/image/this-is.png`
  ],
];
